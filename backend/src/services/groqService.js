...
import { SYSTEM_PROMPT, FALLBACK_RESPONSES, ABOUT_DEVI_RESPONSE } from '../config/prompts.js';
...
export function updateCallMemory(callSid, userText, aiText) {
  ...
  if (!mem.intent) {
    ...
    else if (/complaint|problem|issue|shikayat/.test(lower)) mem.intent = 'complaint';
